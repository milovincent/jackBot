...
if __name__ == '__main__':
    basebot.run_minibot(botname='jackBot', nickname='jackBot', log_users=True,
                        regexes={
                            ...
                            '(?i)([\s\S]*?)how([\s\S]*?)many (?!(people|players|participants))([\s\S]*?)jackbox': 'There are 25 games total that @DoctorNumberFour has, and 10 that =3 has. Most games require at least 3 players (though Guesspionage and Fibbage only require 2 (and Trivia Murder Party and You Don\'t Know Jack only require 1! ^^)) and can hold up to 8 players, though Bracketeering can hold up to 16. In the future, please use !games for the number of games, and !players [game] for number of players.',
