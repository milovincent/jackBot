...
if __name__ == '__main__':
    basebot.run_minibot(botname='jackBot', nickname='jackBot', log_users=True,
                        regexes={
                            ...
                            '(?i)([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|\btee\.?\sk\.?\so\b|\bt\.?\s?k\.?\s?o\b|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp|zeeple dome|mad verse city|y.{0,2}d.{0,2}k.{0,2}j|you don\'?t know jack|patently stupid|split the room).{0,2}a.{0,2}game': 'Yes!',
