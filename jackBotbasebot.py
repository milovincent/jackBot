...
if __name__ == '__main__':
    basebot.run_minibot(botname='jackBot', nickname='jackBot', log_users=True,
                        regexes={
                            ...
                            '(?i)([\s\S]*?)how([\s\S]*?)many (?!(people|players|participants))([\s\S]*?)jackbox': 'There are 25 games total that @DoctorNumberFour has, and 10 that =3 has. Most games require at least 3 players (though Guesspionage and Fibbage only require 2 (and several only require 1! ^^)) and can hold up to 8 players, though Bracketeering can hold up to 16. In the future, please use !games for the number of games, and !players [game] for number of players.',
                            '(?i)([\s\S]*?)how([\s\S]*?)many([\s\S]*?)(people|players|participants)([\s\S]*?)(?!(need|have|must))([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp|zeeple dome|mad verse city|y.{0,2}d.{0,2}k.{0,2}j|you don\'?t know jack|patently stupid|split the room)': 'Most games require at least 3 players (though Guesspionage and Fibbage only require 2 (and Trivia Murder Party only requires 1! ^^)) and can hold up to 8 players, though Bracketeering can hold up to 16.',
                            '(?i)([\s\S]*?)how([\s\S]*?)many([\s\S]*?)(people|players|participants)([\s\S]*?)(need|have|must)([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp|zeeple dome|mad verse city|y.{0,2}d.{0,2}k.{0,2}j|you don\'?t know jack|patently stupid|split the room)': 'Most games require at least 3 players (though Guesspionage and Fibbage only require 2 (and Trivia Murder Party only requires 1! ^^)).',
                            ...
                            '(?i)great.{0,2}scott': myThing, '(?i).*?(?!(reddit.com))\\b(?!(reddit\\.com))/?r/([\S]*)(?!(/))\\b(?!(comments))': linker, '(?i).*?(?!(reddit.com))\\b(?!(reddit\\.com))/?u/([\S]*)(?!(/))\\b(?!(comments))': linkeru,
                            '^!kill @jackbot$': kill,
                            ...
                            '(?i)^!games$': 'There are 25 games total that @DoctorNumberFour has, and 10 that =3 has. There are a total of 25 Jackbox games.',
                            '^!players$': 'Most games require at least 3 players (though Guesspionage and Fibbage only require 2 and several only require 1) and can hold up to 8 players (though Bracketeering can hold up to 16, Bidiots holds 6, and Bomb Corp can only hold 4).',
