...
if __name__ == '__main__':
    basebot.run_minibot(botname='jackBot', nickname='jackBot', short_help='Just ask!', log_users=True,
                        regexes={
                            ...
                            '(?i)([\s\S]*?)how([\s\S]*?)many([\s\S]*?)(people|players|participants)([\s\S]*?)(?!(need|have|must))([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': 'Most games require at least 3 players (though Guesspionage and Fibbage only require 2 (and Trivia Murder Party only requires 1! ^^)) and can hold up to 8 players, though Bracketeering can hold up to 16.',
                            '(?i)([\s\S]*?)how([\s\S]*?)many([\s\S]*?)(people|players|participants)([\s\S]*?)(need|have|must)([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': 'Most games require at least 3 players (though Guesspionage and Fibbage only require 2 (and Trivia Murder Party only requires 1! ^^)).',
                            '(?i)([\s\S]*?)(what|\\bwat\\b|how(?!(many|join|play|win))|why|tell([\s\S]*?)about)([\s\S]*?)(?!(quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp))([\s\S]*?)jackbox([\s\S]*?)(?!(quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp))': 'Jackbox games are a series of games that someone hosts (ask @DoctorNumberFour or niek) and everybody can play, by opening a stream (probably at grv.to/jackboxkcd (Doctor\'s stream) or maybe at mixer.com/niekie (niek\'s stream)) on a browser tab or somewhere else, where there is a 4-character code for the current game. Then they go to jackbox.tv in another browser tab or on their smartphone, and enter the code and a nickname there. Most games need 3 players or more.\nThere are euphoria themed games, as well as fast or slow-paced games, and trivia or drawing games as well. It\'s all lots of fun!',
                            '(?i)([\s\S]*?)where([\s\S]*?)(watch|stream)([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': 'There are three locations. Most often, @DoctorNumberFour streams at grv.to/jackboxkcd, or his youtube channel, https://www.youtube.com/c/MiloSzecket_says_the_fourth_doctor_is_the_best_one/live (yes he knows how stupid the url is), and sometimes niek streams at mixer.com/niekie.',
                            '(?i)([\s\S]*?)(how|where)([\s\S]*?)(join|participate)([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': ' First, start watching a stream, and to play the games, go to jackbox.tv and type in the room code when it comes up (4 capital letters).',
                            '(?i)([\s\S]*?)where(?!(join|participate|watch|stream|not))([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': 'There are three locations. Most often, @DoctorNumberFour streams at grv.to/jackboxkcd, or his youtube channel, https://www.youtube.com/c/MiloSzecket_says_the_fourth_doctor_is_the_best_one/live (yes he knows how stupid the url is), and sometimes niek streams at mixer.com/niekie. If you\'re asking what page to go to to play, that\'s jackbox.tv.',
                            '(?i)([\s\S]*?)when([\s\S]*?)(?!(jackbox.{0,2}(created|founded|made)|(created|founded|made).{0,2}jackbox))([\s\S]*?)(bomb corp|jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': 'Ask @DoctorNumberFour or niek! Probably right now! https://mixer.com/DoctorNumberFour or grv.to/jackboxkcd (Doctor\'s stream), https://www.youtube.com/c/MiloSzecket_says_the_fourth_doctor_is_the_best_one/live (Doctor\'s youtube) or mixer.com/niekie (niek\'s stream).',
                            '(?i)([\s\S]*?)who([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)': 'Normally it\'s either @DoctorNumberFour or niek, but I\'d ask @DoctorNumberFour first, he\'s usually more available. If it\'s Doctor #4 streaming, the stream site is probably https://mixer.com/DoctorNumberFour, but it could also be grv.to/jackboxkcd or his youtube:  https://www.youtube.com/c/MiloSzecket_says_the_fourth_doctor_is_the_best_one/live, and if it\'s niek streaming, the site is mixer.com/niekie.',
                            '(?i)([\s\S]*?)when([\s\S]*?)(jackbox(created|founded|made)|(created|founded|made)jackbox)': 'Jackbox was founded in 2008.',
                            '(?i)^!(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp)\s?specifics': 'These are the games we could be playing, from most likely to least likely:  \n\nMad Verse City (3-8 players) - You and at least 2 friends (and Gene) play rap-battlin\' robots!\n\nBracketeering (3-16 players) - The deranged debate tournament! Place smart bets on what will win stupid arguments.\n\nCivic Doodle (3-8 players) - Compete to see who can make the best additions to a mural in your attempt to "beautify" the city.\n\nQuiplash XL/2 (3-8 players) - The laugh-a-minute battle of wits and wittiness, sometimes with Euph-flavored flair!\n\nTee K.O. (3-8 players) - Draw pictures, write slogans, then swap them around to create your own custom t-shirt warriors. You can even buy them at the end!  \n\nTrivia Murder Party (1-8 players) - Be the last to survive a serial killer\'s absurd trivia game show. But it\'s fun!  \n\nEarwax (3-8 players) - It\'s the sound effects game that\'ll have you up to your ears in laughter!  \n\nGuesspionage (2-8 players) - Guess the percentages of people that do things, based on internet surveys. And it\'s fun!  \n\nBidiots (3-6 players) - Outbid your opponents for absurd art – drawn by players themselves – and win this strangely competitive auction game! \n\nSurvive the Internet (3-8 players) - It\'s survival of the funniest as you playfully take your friends out of context across the World Wide Web.  \n\nFibbage 3 (2-8 players) - Fib your way through this all new version of the classic, which is the same, but more 70s-themed.\n\nFibbage: Enough About You (3-8 players) - Fibbage with facts about the players!\n\nFibbage 2 (3-8 players) - Lie to your friends, avoid their lies, and spot the truth.\n\nBomb Corp (1-4 players): You work in an office. With bombs. (NOTE: hard to play with any lag)',
                            ...
                            '(?i)([\s\S]*?)(jackbox|quiplash|bracketeering|earwax|trivia murder party|t.m.p.|tmp|tee K.O.|tko|civic doodle|fibbage|guesspionage|bidiots|survive the internet|bomb corp).{0,2}a.{0,2}game': 'Yes!',
                            ...
                            '(?i)great.{0,2}scott': myThing, '(?i).*?(?!(reddit.com))\\b(?!(reddit\\.com))?!(\.com)/?r/([\S]*)(?!(/))\\b(?!(comments))': linker, '(?i).*?(?!(reddit.com))\\b(?!(reddit\\.com))/?u/([\S]*)(?!(/))\\b(?!(comments))': linkeru,
                            '^!kill @jackbot$': kill,
                            ...
                            '(?i)^!games (niek|niekie|@niek)$': 'niek has 10 of 25 Jackbox games.',
                            '(?i)^!games (dnf|doctornumberfour|dn4|@DoctorNumberFour)$': '@DoctorNumberFour has 25 of 25 Jackbox games.',
                            '(?i)^!games$': 'There are 25 games total that @DoctorNumberFour has, and 10 that niek has. There are a total of 25 Jackbox games.',
                            '^!players$': 'Most games require at least 3 players (though Guesspionage and Fibbage only require 2 and Trivia Murder Party and Bomb Corp only require 1) and can hold up to 8 players (though Bracketeering can hold up to 16, Bidiots holds 6, and Bomb Corp can only hold 4).',
